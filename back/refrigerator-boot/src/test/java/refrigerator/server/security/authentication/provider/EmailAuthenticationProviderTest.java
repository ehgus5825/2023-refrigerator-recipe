package refrigerator.server.security.authentication.provider;
...
import refrigerator.server.security.authentication.application.provider.EmailAuthenticationProvider;
import refrigerator.server.security.common.exception.CustomAuthenticationException;
import refrigerator.server.security.authentication.application.provider.EmailAuthenticationToken;
import refrigerator.server.security.authentication.application.provider.User;
...
class EmailAuthenticationProviderTest {
    ...
    @InjectMocks
    EmailAuthenticationProvider provider;
    ...
    void authenticateSuccessTest() {
        ...
        given(service.loadUserByUsername("username"))
