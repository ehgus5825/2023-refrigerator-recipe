package refrigerator.server.api.recipe.controller;
...
import refrigerator.server.api.recipe.cookie.RecipeViewsCookie;
...
public class RecipeLookUpController {
    ...
    public InRecipeDto findRecipeOne(
    ...
    private void addToRecipeView(Long recipeId,
                                 HttpServletRequest request,
                                 HttpServletResponse response) {
