...
class RecipeIngredientDtoTest {
    ...
    void matchSuccessTest1() {
        // given
        RecipeIngredientDto recipeIngredient = new RecipeIngredientDto(1L, "사과", "5g", "개", "1", "주재료", null);
    ...
    void matchFailTest2() {
        // given
        RecipeIngredientDto recipeIngredient = new RecipeIngredientDto(1L, "사과", "5g", "개", "5", "주재료", null);
